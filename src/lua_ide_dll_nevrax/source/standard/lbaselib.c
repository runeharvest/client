...
static int luaB_require(lua_State *L) {
  ...
  default: {
    return luaL_error(L, "error loading package `%s' (%s)", lua_tostring(L, 1),
                      lua_tostring(L, -1));
  }
  }
}
...
static const luaL_reg base_funcs[] = {{"error", luaB_error},
...
static const luaL_reg co_funcs[] = {
    {"create", luaB_cocreate}, {"wrap", luaB_cowrap},
    {"resume", luaB_coresume}, {"yield", luaB_yield},
    {"status", luaB_costatus}, {NULL, NULL}};
