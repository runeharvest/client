...
CWnd *CCJToolBar::InsertControl(CRuntimeClass *pClass, CString strTitle,
...
void CCJToolBar::DrawBorders(CDC *pDC, CRect &rect) {
  ...
  {
    pDC->FillSolidRect(0, rect.bottom - 1, rect.right, rect.bottom,
                       m_clrShadow);
    rect.bottom--;
  }
...
void CCJToolBar::OnNcCalcSize(BOOL bCalcValidRects,
