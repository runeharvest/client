...
//			1.01	02 Jan 1999 - Cleaned up class source, wrapped
//all pager 								  messages.
// ==========================================================================
//
/////////////////////////////////////////////////////////////////////////////
...
BOOL CCJPagerCtrl::Create(DWORD dwStyle, const RECT &rect, CWnd *pParentWnd,
                          UINT nID) {
  return CWnd::Create(WC_PAGESCROLLER, NULL, dwStyle, CRect(0, 0, 0, 0),
                      pParentWnd, nID);
}
...
BOOL CCJPagerCtrl::OnPagerCalcSize(NMPGCALCSIZE *pNMPGCalcSize,
                                   LRESULT *pResult) {
