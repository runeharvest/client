...
//			1.01	05 Oct 1998	- Fixed offset bug to use
//GetSystemMetrics(), 								  instead of hard coded values - 								  Todd Brannam
//(tbrannam@msn.com). 			1.02	02 Nov 1998 - Added OnSetFocus(), OnKillFocus()
//and 								  modified OnPaint() so the control remains 								  beveled until it actually looses
//focus - 								  (Vachik Hovhannissian). 			1.03	02 Jan 1999 - Renamed class from
//CJComboBox to CCJFlatComboBox, 								  changed DRAWSTATE to enum, removed method
//Offset(), 								  and replaced with a direct call to ::GetSystemMetrics(). 			1.04
//22 Jan 1999 - Fixed  problem reported by YOSH YAMASHITA
//								  (yosh@muj.biglobe.ne.jp)
//with Matt Weagle's solution of 								  overloading PreTranslateMessage().
// ==========================================================================
//
/////////////////////////////////////////////////////////////////////////////
...
void CCJFlatComboBox::DrawCombo(DRAWSTATE eStyle, COLORREF clrTopLeft,
