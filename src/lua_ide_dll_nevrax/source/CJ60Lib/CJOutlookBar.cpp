...
//
// Acknowledgements:
//	<>  Thanks to Shekar Narayanan (ShekarNarayanan@Hotmail.com) for his
//article 		'A Cool Looking Menu For Easier Navigation' which is where I got the
...
void CCJOutlookBar::OnLButtonUp(UINT nFlags, CPoint point) {
  ...
  p_Owner->SendMessage(WM_OUTLOOKBAR_NOTIFY, OBM_ITEMCLICK, GetCurSel());
