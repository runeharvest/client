...
public:
  ...
  /** Safe version of operator[], returning a defined value for invalid
   * position. */
  ...
  bool IsLeadByte(char ch) { return codePage && InternalIsLeadByte(ch); }
  ...
  virtual int IndentAmount(int line, int *flags,
                           PFNIsCommentLeader pfnIsCommentLeader = 0) = 0;
};
