...
// interface definition file which contains any comments about the definitions.
// HFacer.py does the generation.
...
// Here should be placed typedefs for uptr_t, an unsigned integer type large
// enough to hold a pointer and sptr_t, a signed integer large enough to hold a
// pointer. May need to be changed for 64 bit platforms.
#ifdef __int3264
