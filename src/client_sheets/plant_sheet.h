...
public:
  ...
  bool InheritScale;
  bool InheritRot;
  // for Micro-life primitives only : gives min & max angle of landscape normal
  // toward K for which fx can be spawned
  float AngleMin;
  float AngleMax;
  bool DontRotate;
...
public:
  ...
  virtual void build(const NLGEORGES::UFormElm &item, NLMISC::CSheetId parentId,
