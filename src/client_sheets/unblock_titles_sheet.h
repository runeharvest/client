...
public:
  CUnblockTitlesSheet() { Type = UNBLOCK_TITLES; }
  /// destructor
  ...
  /// serialize
  virtual void serial(NLMISC::IStream &f) { f.serialCont(TitlesUnblock); }

public:
  std::vector<STitleUnblock>
      TitlesUnblock; // There is NB_CHARACTER_TITLE TitleUnblock
};
