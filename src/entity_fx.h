...
public:
   ...
   */
  CEntityFx(const std::string &FxName, const std::string &InstanceName,
            const NLMISC::CVector &Position, const NLMISC::CQuat &Rotation);
...
void newFx(const std::string &FxName, const std::string &InstanceName,
           const NLMISC::CVector &Position, const NLMISC::CQuat &Rotation);
