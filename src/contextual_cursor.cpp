...
// Constructor.
//-----------------------------------------------
CContextualCursor::CContextualCursor() {} // CContextualCursor //
...
//-----------------------------------------------
void CContextualCursor::add(bool isString, const std::string &contextName,
                            const std::string &texture, float distMax,
                            TFunc checkFunc, TFunc2 execFunc, bool replace) {
...
//-----------------------------------------------
bool CContextualCursor::context(const std::string &contextName, float dist,
                                const std::string &cursName) {
  // Delete the context.
  TContext::iterator it = _Contexts.find(contextName);
  if (it == _Contexts.end())
    return false;
