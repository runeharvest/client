...
class CDisplayerVisualActivitySequence : public CDisplayerVisual,
...
private:
  ...
  // need to know when one of the component world pos is changed (no
  // notification message reach us if word pos update is due to a parent)
  ...
  // allows to know when to update us if visibility of one of the primitive has
  // changed
...
protected:
  ...
  // if entiyDV == groupDV, then an ungrouped entity, else the group an its
  // entity
