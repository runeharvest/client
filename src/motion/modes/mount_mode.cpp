...
void CUserControls::mountModeStart() {
  ...
  //	UserEntity->walkVelocity(((float)(instance->getDbProp("SERVER:USER:MOUNT_WALK_SPEED")->getValue32()))/1000.0f);
  //// was: 2.8f
  //	UserEntity->runVelocity(((float)(instance->getDbProp("SERVER:USER:MOUNT_RUN_SPEED")->getValue32()))/1000.0f);
  //// was: 12.f
