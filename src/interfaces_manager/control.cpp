...
// Constructor.
//-----------------------------------------------
CControl::CControl(uint id, float x, float y, float x_pixel, float y_pixel,
...
// Constructor.
//-----------------------------------------------
void CControl::init(uint id, float x, float y, float x_pixel, float y_pixel,
                    float w, float h, float w_pixel, float h_pixel) {
  // Not child.
  _Children.clear();
...
// Return the Hot Spot.
//-----------------------------------------------
CControl::THotSpot CControl::hotSpot() { return _HotSpot; } // hotSpot //

//-----------------------------------------------
// show :
// Hide or show the control. false -> hide, true -> show.
//-----------------------------------------------
void CControl::show(bool show) { _Show = show; } // show //

//-----------------------------------------------
// show :
// Return the show of the control.
//-----------------------------------------------
bool CControl::show() { return _Show; } // show //
...
//-----------------------------------------------
// calculateHS :
// Calculate the display position of the control in relation to the position of
// the control (Hot Spot).
//-----------------------------------------------
...
//-----------------------------------------------
void CControl::click(float x, float y, bool &taken) {} // click //

//-----------------------------------------------
// clickRight :
// manage right mouse button click
//-----------------------------------------------
void CControl::clickRight(float x, float y, bool &taken) {} // clickRight //
...
//-----------------------------------------------
void CControl::getPosition(float &x, float &y, float &xPixel,
                           float &yPixel) const {
  x = _X;
  y = _Y;
  xPixel = _X_Pixel;
