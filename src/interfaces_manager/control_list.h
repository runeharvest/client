...
public:
  /// Constructor
  CControlList(uint id, float x, float y, float x_pixel, float y_pixel, float w,
               float h, float w_pixel, float h_pixel, uint16 spacing);
   ...
   * \param bool pushFront if true the new control will be added in front of the
   * list instead of the end, and so will be displayed at the top of the list
   */
