...
CButtonBase::CButtonBase(uint tOn, uint tOff, uint tDisable) {
  init(tOn, tOff, tDisable, CRGBA(255, 0, 0), CRGBA(0, 255, 0),
       CRGBA(100, 100, 100));
} // CButtonBase //
//-----------------------------------------------
// CButtonBase :
// Constructor.
//-----------------------------------------------
CButtonBase::CButtonBase(const CRGBA &on, const CRGBA &off,
                         const CRGBA &disable) {
...
// Constructor.
//-----------------------------------------------
CButtonBase::CButtonBase(uint tOn, uint tOff, uint tDisable, const CRGBA &on,
                         const CRGBA &off, const CRGBA &disable) {
...
//-----------------------------------------------
void CButtonBase::init(uint tOn, uint tOff, uint tDisable, const CRGBA &on,
                       const CRGBA &off, const CRGBA &disable) {
  _On = false;
  _Enable = true;
  _TextureOn = tOn;
...
// Push the button.
//-----------------------------------------------
void CButtonBase::select() { _On = true; } // push //

//-----------------------------------------------
// unPush :
// Un-push the button.
//-----------------------------------------------
void CButtonBase::unSelect() { _On = false; } // unPush //

//-----------------------------------------------
// enable :
// Get the state of the button(Enable/Disable).
//-----------------------------------------------
bool CButtonBase::enable() { return _Enable; } // enable //

//-----------------------------------------------
// enable :
// Enable or Disable the Button.
//-----------------------------------------------
void CButtonBase::enable(bool e) { _Enable = e; } // enable //
