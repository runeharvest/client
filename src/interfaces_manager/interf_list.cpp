...
// Constructor.
//-----------------------------------------------
CList::CList(uint id) : CScrollableControl(id) { init(); } // CList //

//-----------------------------------------------
// CList :
// Constructor.
//-----------------------------------------------
CList::CList(uint id, float x, float y, float x_pixel, float y_pixel, float w,
...
// scrollH :
//-----------------------------------------------
void CList::scrollH(sint32 scroll) {} // scrollH //
