...
// Constructor :
//---------------------------------------------------
CBrickReceptacle::CBrickReceptacle(uint id) { init(); } // Constructor //

//---------------------------------------------------
// Constructor :
//---------------------------------------------------
CBrickReceptacle::CBrickReceptacle(uint id, float x, float y, float x_pixel,
                                   float y_pixel, float w, float h,
                                   float w_pixel, float h_pixel, uint texture,
                                   const CRGBA &rgba, uint16 family,
                                   uint numFunc)
...
// Destructor :
//---------------------------------------------------
CBrickReceptacle::~CBrickReceptacle() { clear(); } // Destructor //
...
void CBrickReceptacle::display() {
  ...
  if (_Brick != NULL) {
    _Brick->setPosition(_X + _W / 2, _Y + _H / 2, _X_Pixel + _W_Pixel / 2,
                        _Y_Pixel + _H_Pixel / 2);
    _Brick->display();
  } else {
