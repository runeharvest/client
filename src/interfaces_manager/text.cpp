...
// Constructor.
//-----------------------------------------------
CText::CText(uint id) : CControl(id) { init(ucstring("")); } // CText //

//-----------------------------------------------
// CText :
// Constructor.
//-----------------------------------------------
CText::CText(uint id, float x, float y, float x_pixel, float y_pixel,
             const ucstring &text, const CPen &pen)
...
//-----------------------------------------------
CText::CText(uint id, float x, float y, float x_pixel, float y_pixel,
             const ucstring &text, uint32 fontSize, CRGBA color, bool shadow)
    : CControl(id, x, y, x_pixel, y_pixel, 0.f, 0.f, 0.f, 0.f),
