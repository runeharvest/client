...
public:
  ...
  struct SCont {
    std::string Id;
    uint8 ContainerMode; // 0 - Normal, 1 - Small (save just Opened,
                         // ActiveSavable and Active)
    bool Popuped;
    bool Opened;
    sint32 X;
    sint32 Y;
  ...
  public:
    ...
    NLMISC::CMemStream
        ExtraDatas; // TODO : replace it with some polymorphic scheme
    //
    CDesktopImage();
    ...
    // Update image of the given group container (added to the list if it does
    // not exist)
