...
public:
  ...
  CDBCtrlSheet *SrcSheet; // the sheet for which info should be displayed
                          // (outside of the help window)
  CDBCtrlSheet
      *DestSheet; // copy of the sheet for which info are asked (this sheet is
                  // in the help window, the source sheet is copied in it)
  std::string ViewText; // id of the text inside the help window that receive
                        // infos about the sheet
  std::string
      ViewTextID; // id of the text_id inside the help window that receive infos
                  // about the sheet (for dynamic infos -> missions)
  std::string
      ScrollTextGroup; // name of the group that contains the description text
  std::string ScrollTextIdGroup; // name of the group that contains the
                                 // description text_id
  std::string CreatorViewTextID; // name of the text_id in the help window that
                                 // contain the name of the item's creator
  std::string PrefixForExtra; // Id Prefix for list brick and mp stats (from the
                              // help window root)
  bool FromBotChat;
...
public:
  ...
  static CInterfaceGroup *activateNextWindow(CDBCtrlSheet *elt,
...
private:
  ...
  class CFittedWeaponWeightObserver
