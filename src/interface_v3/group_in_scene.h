 ...
 *	NB: it does require that you change the Position each frame, but you
 *don't have to call invalidateCoords() each frame \author Cyril 'Hulud'
 *Corvazier \author Nevrax France \date 2003
 */
...
protected:
  // Projected Position memorized. x/y is in window coordinate, while z in is
  // world/camera coordinate
  ...
  void computeWindowPos(sint32 &newX, sint32 &newY,
                        NLMISC::CVector &newProjCenter);
