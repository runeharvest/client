 ...
 *	The best position is returned: if entity in vision, its pos is returned,
 *else take from Database \author Matthieu Besson \author Nevrax France \date
 *February 2003
 */
...
protected:
  ...
  // if no entity is available, then can retrieve less precise position from
  // database
...
// ***************************************************************************
/**
 * Implementation of CPositionState for an entity that is identified by its
 * compressed uid \author Nicolas Vizerie \author Nevrax France \date 2004
 */
...
// ***************************************************************************
/**
 * Implementation of CPositionState for an entity that is identified by its name
 * (encoded as a dynamic string id in db) \author Nicolas Vizerie \author Nevrax
 * France \date 2004
 */
...
public:
  ...
  void build(NLMISC::CCDBNodeLeaf *name, NLMISC::CCDBNodeLeaf *x,
             NLMISC::CCDBNodeLeaf *y);
 ...
 *	The best position is returned: if entity in vision, its pos is returned,
 *else take from Database \author Lionel Berenguier \author Nevrax France \date
 *2003
 */
...
// ***************************************************************************
/**
 * A class used to retrieve position of some entities sent by server as "compass
 *dialog" The best position is returned: if entity in vision, its pos is
 *returned, else take from Database \author Matthieu Besson \author Nevrax
 *France \date February 2003
 */
