...
public:
  ...
  virtual void
  onPreHrcMove(); // instance is about to move in the hierarchy of object
  virtual void
  onPostHrcMove(); // instance has moved in the hierarchy of objects
  ...
  virtual void onTargetInstancePreHrcMove(const std::string &refMakerAttr,
                                          sint32 refMakerAttrIndex);
  virtual void onTargetInstancePostHrcMove(const std::string &refMakerAttr,
                                           sint32 refMakerAttrIndex);
  ...
  virtual void onTargetInstanceErased(const std::string &refMakerAttr,
                                      sint32 refMakerAttrIndex);
  virtual void onTargetInstanceEraseRequested(const std::string &refMakerAttr,
                                              sint32 refMakerAttrIndex);
  virtual void onTargetInstanceAttrModified(const std::string &refMakerAttr,
                                            sint32 refMakerAttrIndex,
