...
static const CStringConversion<CEntitySheet::TType>::CPair
    sheetTypeStringTableDef[] = {
...
static CStringConversion<CEntitySheet::TType>
    sheetTypeStringTable(sheetTypeStringTableDef,
                         sizeofarray(sheetTypeStringTableDef),
                         CEntitySheet::UNKNOWN_SHEET_TYPE);
