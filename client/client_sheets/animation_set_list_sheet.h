...
public:
  enum TAnimationId { UnknownAnim = 0xffffffff };
...
public:
  ...
  /// Useful for characters on a mount with rotation animation (because there is
  /// no rotation in the animation).
  double VirtualRot;

  /// Name of the fx to launch with the animation (for backward compatibility,
  /// see _FXSet)
