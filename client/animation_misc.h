...
public:
   ...
   */
  static bool interpolate(NL3D::UAnimationSet *animationSet, uint idAnim,
   ...
   * \warning This Method is slower than the one with the animation Id instead
   * of the animation Name.
   */
  static double getAnimationLength(NL3D::UAnimationSet *animationSet,
   ...
   */
  static double getAnimationAverageSpeed(NL3D::UAnimationSet *animationSet,
                                         const std::string &animName);
  /**
   * Get the average speed of an animation (in meters/sec).
   * \param animationSet : search the animation in this set.
   ...
   */
  static double getAnimationRotation(NL3D::UAnimationSet *animationSet,
                                     const std::string &animName);
  /**
   * Get the rotation done by the animation (in radian).
   * \param animationSet : search the animation in this set.
   ...
   */
  static bool getAnimationMove(NL3D::UAnimationSet *animationSet, uint idAnim,
                               NLMISC::CVector &move);
};
