...
// Constructor.
//-----------------------------------------------
CMultiList::CMultiList(uint id, uint16 nbCol) : CScrollableControl(id) {
  _NbCol = nbCol;
  init();
} // CMultiList //
...
// Constructor.
//-----------------------------------------------
CMultiList::CMultiList(uint id, float x, float y, float x_pixel, float y_pixel,
                       float w, float h, float w_pixel, float h_pixel,
                       const CPen &pen, uint16 nbCol)
...
CMultiList::CMultiList(uint id, float x, float y, float x_pixel, float y_pixel,
                       float w, float h, float w_pixel, float h_pixel,
                       uint32 fontSize, CRGBA color, bool shadow, uint16 nbCol)
    : CScrollableControl(id, x, y, x_pixel, y_pixel, w, h, w_pixel, h_pixel),
...
// scrollH :
//-----------------------------------------------
void CMultiList::scrollH(sint32 scroll) {} // scrollH //
