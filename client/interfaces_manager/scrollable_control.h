...
/**
 * class managing scrollable controls. These controls can use scroll bars thanks
 * to virtual methods \author David Fleury \author Nevrax France \date 2001
 */
...
public:
  ...
  /// constructor
  CScrollableControl(uint id, float x, float y, float x_pixel, float y_pixel,
