...
//		* instantiate CMyCoolBar in your frame window as you would a
//toolbar
...
public:
  ...
  BOOL Create(CWnd *pParentWnd, DWORD dwStyle,
              DWORD dwAfxBarStyle = CBRS_ALIGN_TOP, UINT nID = AFX_IDW_TOOLBAR);
  ...
  //
  BOOL InsertBand(CWnd *pWnd, CSize szMin, int cx = 0, LPCTSTR lpText = NULL,
                  int iWhere = -1, BOOL bNewRow = FALSE);
