...
void CLuaIDEInterfaceImpl::setDebuggedAppMainLoop(
    IDebuggedAppMainLoop *mainAppLoop) {
...
void CLuaIDEInterfaceImpl::prepareDebug(const char *tmpProjectFile,
                                        lua_realloc_t reallocfunc,
                                        lua_free_t freefunc, HWND mainWnd) {
  AFX_MANAGE_STATE(AfxGetStaticModuleState());
  theApp.GetMainFrame()->InitExternalDebug(tmpProjectFile, reallocfunc,
                                           freefunc);
...
void CLuaIDEInterfaceImpl::doMainLoop() { theApp.MainLoop(); }
...
LUA_IDE_API ILuaIDEInterface *GetLuaIDEInterface() { return &Impl; }
