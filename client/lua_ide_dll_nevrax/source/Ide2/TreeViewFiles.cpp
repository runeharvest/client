...
#ifdef _DEBUG
void CTreeViewFiles::AssertValid() const { CTreeView::AssertValid(); }

void CTreeViewFiles::Dump(CDumpContext &dc) const { CTreeView::Dump(dc); }
#endif //_DEBUG
...
void CTreeViewFiles::RemoveAll() { m_pTree->DeleteAllItems(); }
...
void CTreeViewFiles::Sort() { m_pTree->SortChildren(m_hFilesFolder); }
