...
//			1.01	02 Jan 1999 - Code clean up and re-organization,
//renamed 								  CCJButton to CCJFlatButton.
// ==========================================================================
//
/////////////////////////////////////////////////////////////////////////////
...
void CCJFlatButton::DrawIcon(CDC *pDC) {
  ...
  if (hIcon) {
    ...
    DrawIconEx(pDC->GetSafeHdc(), m_rcItem.left, m_rcItem.top, hIcon,
               m_rcItem.Width(), m_rcItem.Height(), NULL, (HBRUSH)NULL,
               DI_NORMAL);
  } else if (hBitmap) {
    // not implemented.
  } else {
