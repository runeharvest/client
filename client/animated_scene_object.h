...
public:
  ...
  // (TODO: add control to animation launched and manage some mode (loop, repeat
  // number, sequences..)
  ...
  void applyDeltaRotationAndPosition(NLMISC::CQuat &rot,
                                     NLMISC::CVector &trans);
...
void addAnimatedSceneObject(const std::string &AnimatedSceneObjectName,
                            const string &ClusterIG,
                            const std::string &MeshName,
                            const std::string &SkeletonName,
                            const std::list<std::string> &Animations,
                            const NLMISC::CVector &Position,
                            const NLMISC::CQuat &Rotation, float Distance);
void addEntityClAnimatedSceneObject(const NLMISC::CEntityId &Id,
                                    const std::list<std::string> &Animations);
void addUknowTypeSceneObject(const NLMISC::CEntityId &id,
                             NL3D::UTransform *Transform,
                             const std::list<std::string> &Animations,
                             bool displacement = true);
void updateAnimationSequence(const NLMISC::CEntityId &id,
                             const std::list<std::string> &sequence,
                             uint32 idSequence);
