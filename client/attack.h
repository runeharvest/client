...
public:
  ...
  // anim fx set for custom projectile part (whether custom projectile is used
  // is told in 'Sheet');
  CAnimationFXSet ProjectileFXSet;
  // anim fx set for custom impact part (whether custom impact is used is told
  // in 'Sheet');
...
private:
  typedef std::map<std::string, CCreatureAttack,
