...
void sendMsgToServer(const string &sMsg, uint8 u8n1, uint8 u8n2, uint8 u8n3) {
  CBitMemStream out;
  if (GenericMsgHeaderMngr.pushNameToStream(sMsg, out)) {
    // nlinfo("impulseCallBack : %s %d %d %d sent", sMsg.c_str(), u8n1, u8n2,
    // u8n3);
    out.serial(u8n1);
    out.serial(u8n2);
    out.serial(u8n3);
...
void sendMsgToServer(const string &sMsg, uint8 u8n1, uint8 u8n2, uint8 u8n3,
  ...
  CBitMemStream out;
  if (GenericMsgHeaderMngr.pushNameToStream(sMsg, out)) {
    // nlinfo("impulseCallBack : %s %d %d %d %d sent", sMsg.c_str(), u8n1, u8n2,
    // u8n3, u8n4);
    out.serial(u8n1);
    out.serial(u8n2);
    out.serial(u8n3);
...
// sendMsgToServer Helper
void sendMsgToServer(const string &sMsg, uint8 u8n1, uint8 u8n2, uint8 u8n3,
                     uint8 u8n4, uint8 u8n5) {
  CBitMemStream out;
  if (GenericMsgHeaderMngr.pushNameToStream(sMsg, out)) {
    // nlinfo("impulseCallBack : %s %d %d %d %d %d sent", sMsg.c_str(), u8n1,
    // u8n2, u8n3, u8n4, u8n5);
    out.serial(u8n1);
    out.serial(u8n2);
    out.serial(u8n3);
...
void sendMsgToServer(const string &sMsg, uint32 u32n1, uint8 u8n2, uint8 u8n3) {
  CBitMemStream out;
  if (GenericMsgHeaderMngr.pushNameToStream(sMsg, out)) {
    // nlinfo("impulseCallBack : %s %d %d %d sent", sMsg.c_str(), u32n1, u8n2,
    // u8n3);
    out.serial(u32n1);
    out.serial(u8n2);
    out.serial(u8n3);
