...
CGroupHTMLCS::CGroupHTMLCS(const TCtorParam &param) : CGroupHTML(param) {
  Home.clear();
}
...
void CGroupHTMLCS::addHTTPPostParams(SFormFields &formfields,
                                     bool /*trustedDomain*/) {
  std::vector<CParameter> parameters;
...
string CGroupHTMLCS::home() const { return Home; }
...
void CGroupHTMLCS::getParameters(std::vector<CParameter> &parameters,
                                 bool encodeForUrl) {
